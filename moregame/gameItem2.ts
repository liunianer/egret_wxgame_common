class gameItem2 extends eui.ItemRenderer implements  eui.UIComponent {
	public constructor() {
		super();
		this.skinName='gameItem2Skin';
	}
	...
	protected dataChanged(){
		...
		if(this.data.efftype==1){
			...
			egret.Tween.get(this.guang,{loop:true}).to({x:150,y:-150},1000)
		}
