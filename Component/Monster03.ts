class Monster03 extends MonsterBase{
    public constructor(){
        super();
        this.skinName='Monster03Skin';
    }
    ...
    public state =0;
    public _data =[{state:'b',harm:20,hp:240,gold:7},{state:'a',harm:40,hp:480,gold:9},{state:'s',harm:60,hp:1440,gold:14}]
	...
	public init(){
        ...
        this.armatureDisplay = Common.creatDragonbones('xiaoguai3');
